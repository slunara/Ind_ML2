...
if st.button("Predict"): 
    ...
    if result == "yes":
        st.markdown(f'<span style="color:green; font-size:16px;">The client will accept the offer</span>', unsafe_allow_html=True)
    else:
        st.markdown(f'<span style="color:red; font-size:16px;">The client will reject the offer</span>', unsafe_allow_html=True)
